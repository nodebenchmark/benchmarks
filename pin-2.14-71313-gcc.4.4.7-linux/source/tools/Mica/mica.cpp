...
KNOB<string> KnobOutputFile(KNOB_MODE_WRITEONCE, "pintool",
        "o", "mica.out", "specify output file name");
...
VOID PinControls(INS ins, void *v)
{
...
VOID countInsts(INS ins, void *v)
{
...
int main(int argc, char* argv[]){
    ...
    INS_AddInstrumentFunction(PinControls, 0);
    INS_AddInstrumentFunction(countInsts, 0);
    ...
    result_file.open(KnobOutputFile.Value().c_str());
    result_file.setf(ios::showbase);
